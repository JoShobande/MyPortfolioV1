    ...
    return(
        <nav className='flex justify-between items-center'>
            ...
            <div className='hidden lg:flex'>
                <div 
                    className='grid place-content-center border border-[#66CCFF] hover:border-2 w-[120px] lg:w-[200px] h-[50px] rounded-t-[20px] rounded-br-[20px] cursor-pointer'
                >
                    <Link href='https://github.com/JoShobande' target='_blank' className='flex items-center'>
                ...
                <div 
                    className='grid place-content-center bg-[#707FB7] w-[140px] lg:w-[200px] border-[#707FB7] hover:border-2  h-[50px] rounded-t-[20px] rounded-br-[20px] ml-[15px] cursor-pointer'
                >
                    <Link href='https://docs.google.com/document/d/1zC-oS8Z9WeJOyCxthHHg4vBaDPhTGn7n9iIOQVAYAW4/edit' download target="_blank">
                        <div className='flex items-center'>
